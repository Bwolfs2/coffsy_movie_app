...
class CrewStore extends StreamStore<Failure, List<Crew>> {
  ...
  Future<void> loadMovieTrailer(int movieId) => executeEither(() => DartzEitherAdapter.adapter(_getMovieCrewById(movieId)));
  Future<void> loadTvShowTrailer(int movieId) => executeEither(() => DartzEitherAdapter.adapter(_getTvShowCrewById(movieId)));
}
