import 'package:coffsy_movie_app/app/modules/detail/pages/bloc/trailer/trailer_event.dart';
import 'package:coffsy_movie_app/app/modules/detail/pages/bloc/trailer/trailer_state.dart';
...
class TrailerBloc extends Bloc<TrailerEvent, TrailerState> {
  ...
  Stream<TrailerState> _mapLoadTvShowTrailerToState(int movieId) async* {
    try {
      yield TrailerLoading();
      var tvShow = await repository.getTvShowTrailer(movieId, ApiConstant.apiKey, ApiConstant.language);
