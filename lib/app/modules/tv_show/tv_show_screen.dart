...
import 'pages/airing_today/bloc/tv_airing_today_event.dart';
import 'pages/airing_today/bloc/tv_airing_today_state.dart';
import 'pages/on_the_air/bloc/tv_on_the_air_bloc.dart';
import 'pages/on_the_air/bloc/tv_on_the_air_event.dart';
import 'pages/on_the_air/bloc/tv_on_the_air_state.dart';
import 'pages/popular/bloc/tv_popular_bloc.dart';
import 'pages/popular/bloc/tv_popular_event.dart';
import 'pages/popular/bloc/tv_popular_state.dart';
      ...
      builder: (context, state) {
        if (state is TvOnTheAirHasData) {
          ...
          return BannerHome(
            ...
            routeNameAll: '/tv_show/on_the_air',
          );
