...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void initState() {
    super.initState();
    _loadTrailer(context, widget.arguments.movies.id, widget.arguments.isFromMovie);
    _loadCrew(context, widget.arguments.movies.id, widget.arguments.isFromMovie);
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomButton(
                    text: "Booking Ticket",
                    onPressed: () {
                      Navigation.intentWithData(context, BookingScreen.routeName, ScreenArguments(widget.arguments.movies, true, false));
                    },
                  ),
                ),
              ],
            ...
            builder: (context, state) {
              if (state is TrailerHasData) {
                ...
                return NoInternetWidget(
                  ...
                  onPressed: () => _loadTrailer(context, widget.arguments.movies.id, widget.arguments.isFromMovie),
                );
              } else {
          ...
          child: BlocBuilder<CrewBloc, CrewState>(
            ...
            builder: (context, state) {
              if (state is CrewHasData) {
                ...
                return NoInternetWidget(
                  message: AppConstant.noInternetConnection,
                  onPressed: () => _loadCrew(context, widget.arguments.movies.id, widget.arguments.isFromMovie),
                );
              } else {
                return Center(child: Text(""));
              }
